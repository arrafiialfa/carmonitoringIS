                        ...
                        <div class="">
                            <form class="form-horizontal" method="POST" action="{{ route('driver.store') }}">
                                ...
                                <div class="mt-3">
                                    ...
                                    <x-text-input id="age" class="block mt-1 w-full" type="number" min="0"
                                        max="100" name="age" :value="old('age')" required autocomplete="age" />
                                ...
                                <div class="mt-3">
                                    ...
                                    <x-text-input id="driving_hours" class="block mt-1 w-full" type="number"
                                        min="0" name="driving_hours" :value="old('driving_hours')" required
                                        autocomplete="driving_hours" />
